...
export default function Signin() {
  ...
  return (
    <div>
    <div style={{justifyContent: 'center',width:'25%',marginLeft:'37.5%',marginTop:'8%'}}>
    <h1 className="navbar-brand" style={{ fontSize: '80px', color: '#006BA8', fontFamily:"Playfair Display"}} href='/'><strong>Aurora</strong></h1>
    <img src={require('/Users/elliasmussayev/Desktop/aurora/src/Icon/Aurora.png')} alt="Моя картинка" style={{width: '125px', height: '100px'}} />
    <div style={{ backgroundColor: 'rgba(217, 217, 217, 0.18)', border: '1px solid #006BA8', padding: '20px',marginTop:'5%'}}>
    <div>
    <input type="text" className="form-control" id="email" placeholder="Email/Phone number" style={{width:'65%',background:'rgba(233, 233, 233, 0.56)',marginLeft:'17.5%',marginTop:'10%'}} onChange={(event) => setEmail(event.target.value)}/>
